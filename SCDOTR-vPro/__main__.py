...
def countProductsUsingSupplierById(id_proveedor):
    res = suppliers.countProductsUsingSupplierById(id_proveedor)
    return jsonify(res)
...
def getBestSellingProducts():
    res = statistics.getBestSellingProducts()
    return jsonify(res)
...
def getFechasCompras():
    res = statistics.getFechasCompras()
    return jsonify(res)
...
def getSalesAll():
    res = statistics.obtener_compras_total_ventas()
    return jsonify(res)
...
def getSalesByMonth(mes):
    res = statistics.obtener_compras_total_ventas(mes)
    return jsonify(res)
...
def getBestSellingProductsByMes(mes):
    if mes == 0:
        ...
        res = statistics.getBestSellingProductsByMes(mes)
...
def obtener_productos_vendidos(mes):
    if mes == 0 :
        mes = None
    res = statistics.obtener_productos_vendidos(mes)
...
def getGanaciasByMonth(mes):
    res = statistics.getGanaciasByMonth(mes)
    return jsonify(res)
...
def getPurchaseDetails(idCompra):
    res = statistics.getPurchaseDetails(idCompra)
    return jsonify(res)

# VALIDAR SI SE NECECITA STOCK
@app.route('/stock')
def verifyingStock():
    res = statistics.verifyingStock()
    return jsonify(res)
...
def searchDetails():
    ...
    res = statistics.searchDetails(data['search'], mes)
