                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" onclick="Cobro.loadTicketPDF()" class="btn bg-darkblue-2 text-white " id="generatePDFButton"><i class="bi bi-printer-fill"></i> Imprimir</button>
                            </div>
                        </div>
                    </div>
                </div>`;
